                ...
                <div class="isotope-box">
                    <div class="isotope-item" data-type="nature">
                        <figure class="snip1321">
                            <img src="{{asset('css/assets/images/portfolio-01.jpg')}}" alt="sq-sample26" />
                            <figcaption>
                                <a href="{{asset('css/assets/images/portfolio-01.jpg')}}" data-lightbox="image-1"
                    ...
                    <div class="isotope-item" data-type="people">
                        <figure class="snip1321">
                            <img src="{{asset('css/assets/images/portfolio-02.jpg')}}" alt="sq-sample26" />
                            <figcaption>
                                <a href="{{asset('css/assets/images/portfolio-02.jpg')}}" data-lightbox="image-1"
                                    data-title="Caption"><i class="fa fa-search"></i></a>
                                <h4>Second Title</h4>
                    ...
                    <div class="isotope-item" data-type="animals">
                        <figure class="snip1321">
                            <img src="{{asset('css/assets/images/portfolio-03.jpg')}}" alt="sq-sample26" />
                            <figcaption>
                                <a href="{{asset('css/assets/images/portfolio-03.jpg')}}" data-lightbox="image-1"
                                    data-title="Caption"><i class="fa fa-search"></i></a>
                                <h4>Item Third</h4>
